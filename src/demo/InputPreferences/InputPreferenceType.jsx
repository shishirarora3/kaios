    ...
    return (
        <div>
            ...
            {inputItems.map((item,index)=>{
                ...
                <TextInput placeholder="Type name" label="" ref={item} index={index} onFocusChange={onFocusChange} onChange={onChange} handleKeyDown={handleKeyDown} focusColor="#FFFFFF"/>
                </div>
            })}
